...
/** Translate outside React components, for example static Astro navigation. */
export function translate(key: string, lang: Language = readLang(), params?: Record<string, string | number>): string {
