...
> **Files:** `settings.astro`, `ProfileAvatarSettings.tsx`, `LanguageSettings.tsx`
...
| Avatar | ✅ | Bild-Upload oder Hatches-Icon |
| Sprache | ✅ | Deutsch oder Englisch, sofortige Umschaltung |
...
| Change Password | ✅ | |
| Two-Factor Auth | ❌ | |
| Active Sessions | ✅ | Einzelne oder alle anderen Sitzungen beenden |
