...
> **Files:** `src/components/planner/Planner.tsx`, `src/pages/api/events/`, `src/pages/api/projects/deadlines.ts`
...
|-------------|--------|-------------|
| Kanban Due Dates | ✅ | Card due date → Planner, gekennzeichnet als „Board-Karte“ |
| Project Due Dates | ✅ | Project due date → Planner, gekennzeichnet als „Projekt“ |
