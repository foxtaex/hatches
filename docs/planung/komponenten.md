...
| `ProjectWorkspace` | `src/components/projects/ProjectWorkspace.tsx` | ✅ Implementiert | Projekte |
| `BoardSettingsModal` | `src/components/kanban/BoardSettingsModal.tsx` | ✅ Implementiert | Kanban |
| `ProfileAvatarSettings` | `src/components/settings/ProfileAvatarSettings.tsx` | ✅ Implementiert | Einstellungen |
| `LanguageSettings` | `src/components/settings/LanguageSettings.tsx` | ✅ Implementiert | Einstellungen |
| `ThemedSelect` | `src/components/ui/ThemedSelect.tsx` | ✅ Implementiert | UI |
