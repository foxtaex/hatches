...
![Version](https://img.shields.io/badge/Version-v6.0.00--dev-blue)
...
- **Kanban Board** — Multi-Board, Drag & Drop, Karten-Zuweisung und eine Archiv-Spalte, aus der Karten direkt wieder in normale Spalten gezogen werden können.
- **Hatches-Projektzentrale** — Die Startseite bündelt bestehende Boards und Docs in Projekten, optional in genau einer Unterordner-Ebene, ohne Inhalte zu duplizieren. Projekt-Fälligkeiten erscheinen eindeutig gekennzeichnet im Planner.
...
- **Deutsch & Englisch** — Sprache direkt im Account wechseln; Navigation, Board, Docs, Planner, Projekte, Templates und Einstellungen reagieren sofort.
